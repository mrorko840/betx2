...
Route::namespace('Admin')->prefix('control')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
       ...
       Route::get('aj-noti', 'AdminController@ajaxNoti')->name('ajax-noti');
            
            
         // Super Admin 
        Route::get('manage-admins', 'SuperAdminController@manage_admins')->name('admins.manage');
        Route::get('manage-withdraw-teams', 'SuperAdminController@manage_withdraw_teams')->name('admins.withdraw-teams');
        Route::get('manage-deposit-teams', 'SuperAdminController@manage_deposit_teams')->name('admins.deposit-teams');
        Route::get('manage-agents', 'SuperAdminController@manage_agents')->name('admins.agents');
        
        Route::post('create/{type}', 'SuperAdminController@store')->name('admins.store');
        Route::post('delete-admin/{id}', 'SuperAdminController@delete')->name('admins.delete');
        ...
        //win match
        Route::post('match/winner', 'MatchController@winner')->name('match.winner');
       ...
       Route::get('manage-options', 'OptionsController@manage')->name('score.manage');
        ...
        Route::post('bets/refund', 'BetsController@refund')->name('bet.refund');
        ...
        Route::get('user/notification/{id}', 'ManageUsersController@send_notification')->name('users.notification');
        Route::post('user/notification/{id}', 'ManageUsersController@send_notification_post')->name('users.notification.post');
        
        Route::get('user/notification/log/{id}', 'ManageUsersController@notification_log')->name('users.notification.log');
        Route::post('user/notification/delete/{id}', 'ManageUsersController@notification_delete')->name('users.notification.delete');
        
        Route::get('user/notification/edit/{id}', 'ManageUsersController@notification_details')->name('users.notification.edit');
        Route::post('user/notification/update/{id}', 'ManageUsersController@notification_update')->name('users.notification.update');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::post('ajax-profile-photo', 'UserController@AjaxProfilePhoto')->name('profile.photo');
            Route::get('profile-setting', 'UserController@profile')->name('profile.setting');
            Route::post('profile-setting', 'UserController@submitProfile')->name('profile.submit');
            Route::get('address-setting', 'UserController@Address')->name('address.setting');
            Route::post('address-setting', 'UserController@submitAddress')->name('address.submit');
            Route::get('change-password', 'UserController@changePassword')->name('change.password');
            Route::post('change-password', 'UserController@submitPassword')->name('password.submit');
            ...
            //custom Deposit
            Route::get('/deposit/custom', 'Gateway\PaymentController@customDeposit')->name('deposit.custom');
            ...
            Route::post('deposit/new', 'Gateway\PaymentController@newdeposit')->name('deposit.new');
            Route::get('deposit/new-preview/{id}', 'Gateway\PaymentController@newdepositpreview')->name('deposit.pn');
            ...
            //ajaxPreview
            Route::get('/withdraw/preview-ajax', 'UserController@withdrawPreviewAjax')->name('withdraw.preview_ajax');
            ...
            Route::get('/notification/{id}', 'UserController@notification_details')->name('notification.details');
            
            
            
            Route::post('place-bet', 'UserController@place_bet')->name('place-bet');
...
// Ajax
Route::get('get-bet-info', 'SiteController@get_bet_info')->name('bet.info');


Route::get('/match-list', 'SiteController@matches')->name('match.list');
...
Route::post('/payment-check', 'SiteController@payment_check')->name('check-payment');
// Blog
