...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $viewShare['withdrawMethod'] = WithdrawMethod::where('status',1)->get();
        ...
        view()->composer('admin.partials.topnav', function ($view) {
            $view->with([
                'adminNotifications'=>AdminNotification::where('read_status',0)->with('user')->take(20)->orderBy('id','desc')->get(),
                'adminNotificationscount'=>AdminNotification::where('read_status',0)->with('user')->take(20)->orderBy('id','desc')->count(),
            ]);
        });
