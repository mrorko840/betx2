...
class ManualGatewayController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $method->status             = 0;
        $method->cur_sym            = $request->cur_sym;
        $method->phone_number       = $request->phone_number;
        $method->number_type        = $request->number_type;
        $method->dial_code          = $request->dial_code;
        $method->theme_color        = $request->theme_color;
    ...
    public function update(Request $request, $code)
    {
        ...
        $single_currency->cur_sym           = $request->cur_sym;
        $single_currency->phone_number      = $request->phone_number;
        $single_currency->number_type       = $request->number_type;
        $single_currency->dial_code         = $request->dial_code;
        $single_currency->theme_color       = $request->theme_color;
