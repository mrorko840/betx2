            ...
            <div class="row">
                {{-- <div class="custom-control custom-switch pt-2">
                    ...
                    <label class="custom-control-label" for="darklayout">
                        <span class="material-icons darkIconChange">
                            mode_night
                        </span>
                    </label>
                </div> --}}
    
                <a href="javascript:void(0)" class="btn btn-warning btn-30 neo-shadow btn-link mt-2" data-toggle="modal" data-target="#noticeModal">
                    <span class="material-icons">notifications_none</span>
                    {{-- <span class="counter"></span> --}}
                </a>
                <div style="padding-right: 0.5rem !important;" class="mt-1">
                    <a href="#" class="avatar avatar-30 neo-shadow rounded-circle ml-2 mt-1">
