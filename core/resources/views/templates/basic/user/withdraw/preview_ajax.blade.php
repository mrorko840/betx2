<div class="container">
    <div class="withdraw-preview">
        ...
        <div class="withdraw-form-area">
            <form class="withdraw-form" id="withdrawPreviewForm" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form--group mb-2">
                    <button type="submit" class="btn btn-sm btn-warning border-custom neo-shadow w-100 withdrawSubmit">Withdraw Now</button>
                </div>
            </form>
        </div>
    </div>
