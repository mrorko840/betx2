                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Bet Minimum Limit') </label>
                                    <input class="form-control form-control-lg" type="number" step="0.01" name="min_limit" value="{{getAmount($general->min_limit)}}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label class="form-control-label font-weight-bold">@lang('Bet Maximum Limit') </label>
                                    <input class="form-control form-control-lg" type="number" step="0.01" name="max_limit" value="{{getAmount($general->max_limit)}}" required>
                                </div>
                            </div>
                            @php
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12">
                                        <label class="form-control-label font-weight-bold">@lang('Deposit & Withdraw Preset') </label>
                                    </div>
                                    <div class="col pr-0">
                                        <select class="form-control form-control-lg select2-multliple" name="d_and_w_preset[]" multiple="multiple">
                                            @foreach ($DandW as $dw)
                                                <option selected="selected">{{@$dw}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn--primary btn-block btn-lg w-100">@lang('Update')</button>
                        </div>
                    </form>
                </div>
            </div>
