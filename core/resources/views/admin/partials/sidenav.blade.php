    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                    ...
                    <li class="sidebar-menu-item sidebar-dropdown">
                        ...
                        <div class="sidebar-submenu {{menuActive('admin.frontend.sections*',2)}} ">
                            <ul>
                                ...
                                @endphp
                                <li class="sidebar-menu-item {{ request()->path() == 'control/frontend/frontend-sections/notice' ? 'active' : '' }}">
                                    <a href="{{route('admin.frontend.sections', 'notice')}}" class="nav-link ">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Notice Board')</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item {{ request()->path() == 'control/frontend/frontend-sections/banner' ? 'active' : '' }}">
                                    <a href="{{route('admin.frontend.sections', 'banner')}}" class="nav-link ">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Sliding Banner')</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item {{ request()->path() == 'control/frontend/frontend-sections/links' ? 'active' : '' }}">
                                    <a href="{{route('admin.frontend.sections', 'links')}}" class="nav-link ">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('App Links')</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item {{ request()->path() == 'control/frontend/frontend-sections/importent_links' ? 'active' : '' }}">
                                    <a href="{{route('admin.frontend.sections', 'importent_links')}}" class="nav-link ">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Social Links')</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item {{ request()->path() == 'control/frontend/frontend-sections/fake_review' ? 'active' : '' }}">
                ...
                @if( $adminType == 'superadmin' )
                    <li class="sidebar-menu-item sidebar-dropdown">
                        ...
                        <div class="sidebar-submenu {{menuActive('admin.admins*',2)}}">
                            <ul>
                                <li class="sidebar-menu-item {{menuActive('admin.admins.manage')}}">
                                    <a href="{{ route('admin.admins.manage') }}" class="nav-link">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Admins')</span>
                                    </a>
                                </li>
                                
                                <li class="sidebar-menu-item {{menuActive('admin.admins.withdraw-teams')}}">
                                    <a href="{{ route('admin.admins.withdraw-teams') }}" class="nav-link">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Withdraw Teams')</span>
                                    </a>
                                </li>

                                <li class="sidebar-menu-item {{menuActive('admin.admins.staffs')}}">
                                    <a href="{{ route('admin.admins.deposit-teams') }}" class="nav-link">
                                        <i class="menu-icon las la-dot-circle"></i>
                                        <span class="menu-title">@lang('Deposit Teams')</span>
                                    </a>
                                </li>
                                
                                <!--<li class="sidebar-menu-item {{menuActive('admin.admins.agents')}}">-->
                                <!--    <a href="{{ route('admin.admins.agents') }}" class="nav-link">-->
                                <!--        <i class="menu-icon las la-dot-circle"></i>-->
                ...
                <li class="sidebar-menu-item {{menuActive('admin.score.manage')}}">
                    <a href="{{route('admin.score.manage')}}" class="nav-link ">
                        <i class="menu-icon las la-trophy"></i>
                        <span class="menu-title">@lang('Manage Scores')</span>
                    </a>
                </li>
                ...
                @if( $adminType == 'superadmin' || $adminType == 'depositteam' || $adminType == 'admin' )
                <li class="sidebar-menu-item sidebar-dropdown">
                ...
                @if( $adminType == 'withdrawteam' || $adminType == 'superadmin' || $adminType == 'admin' )
                <li class="sidebar-menu-item sidebar-dropdown">
            ...
            <div class="text-center mb-3">
                <span class="text-white">Develop by</span>
                <a href="https://t.me/iam_mrHemel" target="_blank">
                    <span class="text-warning text-uppercase">
                        <i style="font-size: 20px;" class="lab la-telegram"></i>
                        <b>H E M E L</b>
                    </span>
                </a>
