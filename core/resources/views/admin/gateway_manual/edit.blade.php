                            ...
                            <div class="payment-method-header">
                                <div class="thumb">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview" style="height: 110px; background-image: url('{{ getImage(imagePath()['gateway']['path'].'/'. $method->image,imagePath()['gateway']['path']) }}')"></div>
                                    </div>
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-xl-3 col-md-6">
                                            <div>
                                                ...
                                                <input type="text" name="cur_sym" placeholder="@lang('Symbol')" class="form-control border-radius-5" value="{{ @$method->single_currency->cur_sym }}"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-xl-6 col-md-6">
                                            ...
                                            <span class="input-group-addon ">
                                                <input type='text' class="form-control form-control-lg colorPicker" value="{{@$method->single_currency->theme_color}}"/>
                                            </span>
                                                <input type="text" class="form-control form-control-lg colorCode" name="theme_color" value="{{ @$method->single_currency->theme_color }}"/>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-4 col-md-6">
                                                        <div>
                                                            ...
                                                            <input type="text" name="phone_number" placeholder="Phone Number" class="form-control border-radius-5" value="{{ @$method->single_currency->phone_number }}"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-4 col-md-6">
                                                        ...
                                                        <select class="form-select w-100" name="number_type">
                                                            ...
                                                            <option @if($method->single_currency->number_type == 'personal') selected @endif value="personal">Personal</option>
                                                            <option @if($method->single_currency->number_type == 'agent') selected @endif value="agent">Agent</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-xl-4 col-md-6">
                                                        <div>
                                                            <label class="w-100 font-weight-bold">Dial Code<span class="text-danger">*</span></label>
                                                            <input type="text" name="dial_code" placeholder="ex: *247#" class="form-control border-radius-5" value="{{ @$method->single_currency->dial_code }}"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card border--primary mt-3">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea rows="5" class="form-control border-radius-5 nicEdit" name="instruction">{{ __(@$method->description)  }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div> --}}
